...
A modern SaaS-style Admin Dashboard built with React, TypeScript, TailwindCSS, and Zustand, featuring user management, detailed user profiles, analytics, and polished UI/UX patterns.

This project was built as part of a Frontend Engineer technical assignment.
...
Used a simple JS array as the data source.

Architecture is backend-ready (easy to replace with API / React Query later).

UI Architecture

Reusable, composable components (Card, Button, Modal, Skeleton)
